...
//点击[选择请求文件]按钮事件
void MainWindow::on_pushButton_4_clicked() { selectReqFile(); }
...
//点击[选择证书文件]按钮事件
void MainWindow::on_pushButton_2_clicked() { selectCertFile(); }

//点击[验证证书]按钮事件
void MainWindow::on_pushButton_10_clicked() { rootCaVerify(); }
...
//证书签发tab点击[撤销证书按钮事件]
void MainWindow::on_pushButton_3_clicked() { lightRevokeCert(); }
...
void MainWindow::mouseClicked() {
    ...
    if ("reqfiles" == index1) {
        ...
        ui->textBrowser->append(getTime() + "选中" + index3 +
                                "文件，双击查看内容");
